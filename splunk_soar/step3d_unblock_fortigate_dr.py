#!/usr/bin/env python3
"""
Splunk SOAR Custom Function - Step 3d (undo): Unblock one IP/DOMAIN on FortiGate DR
...
def unblock_fortigate_dr(ioc_type=None, value=None, **kwargs):
    """
    Args:
